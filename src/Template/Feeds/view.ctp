...
<div class="xfeed">
	...
	<p>
		<?php echo $this->Button->button('Fetch poster', 'download', ['controller' => 'feeds', 'action' => 'fetchPoster', $feed->id]); ?>
		<?php echo $this->Button->button('Sync episodes', 'refresh', ['controller' => 'feeds', 'action' => 'syncEpisodes', $feed->id]); ?>
	</p>
	<table>
